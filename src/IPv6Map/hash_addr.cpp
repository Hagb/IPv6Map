...
#include <cstdint>
#include <functional>
size_t std::hash<in_addr6_with_scope>::operator()(const in_addr6_with_scope &a) const {
...
bool std::equal_to<in_addr6_with_scope>::operator()(const in_addr6_with_scope &a, const in_addr6_with_scope &b) const {
